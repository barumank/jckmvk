...
class ProductCategoryService extends BaseServiceEntity
{
    const DIRECTORY_NAME = 'category_images';
    ...
    public function saveImageByRequestFile(File $image): ?string
    {
        ...
        $image->resize(
            ProductCategory::MIN_IMAGE_WIDTH,
            ProductCategory::MIN_IMAGE_HEIGHT,
            \Phalcon\Image::AUTO
        )->save();
