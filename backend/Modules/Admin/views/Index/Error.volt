...
<head>
    ...
    {{ assets.outputCss() }}
    <link rel="stylesheet" href="/css/error/common.css">
</head>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="col-middle">
                <div class="text-center text-center">
                    <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="320px"
                                                          height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
    <rect x="59.722" y="72.779" fill="#333" width="40.557" height="27.564"/>
		...
		C75.85,13.604,65.745,3.39,53.972,3.39">
                                    <animate attributeName="d" calcMode="spline"
                                             keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s"
                                             dur="0.75s" repeatCount="indefinite" values="M77.519,25.869C75.85,13.604,65.745,3.39,53.972,3.39
                          ;
                          ...
                          "/>
                                ...
                                <ellipse fill="#ccc" cx="55.021" cy="3.39" rx="3.344" ry="3.391">
                                    <animate dur="0.75s" attributeName="cy" calcMode="spline"
                                             keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s"
                                             values="
                           3.39;
                           12;
		...
		C84.15,13.604,94.255,3.39,106.028,3.39">
                                    <animate attributeName="d" calcMode="spline"
                                             keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s"
                                             dur="0.6s" repeatCount="indefinite" values="
                          ...
                          "/>
                                ...
                                <ellipse fill="#ccc" cx="104.979" cy="3.39" rx="3.344" ry="3.391">
                                    <animate dur="0.6s" attributeName="cy" calcMode="spline"
                                             keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s"
                                             values="
                           3.39;
                           10.39;
                           ...
                           " repeatCount="indefinite"/>
                            ...
                            <path fill="#adadad" d="M112.809,28.372H80H47.19c-5.814,18.663-5.499,37.322,0,55.983H80h32.811
		C118.309,65.694,118.625,47.035,112.809,28.372z"/>
				...
				s4.044-9.856,9.032-9.856h1.971C68.071,38.099,72.116,42.512,72.116,47.955z">
                                        <animate attributeName="d" calcMode="spline"
                                                 keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s"
		...
		C102.547,67.282,103.383,68.4,103.383,69.778z">
                                <animate attributeName="d" calcMode="spline"
                                         keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s" dur="1s"
                                         repeatCount="indefinite" values="
		...
		C11.02,126.471,9.068,131.177,9.068,131.177z"/>
                                    <path fill="#adadad" d="M9.604,166.5c-6.984,1.975-11.067,9.316-9.117,16.398c1.008,3.662,3.439,6.522,6.51,8.172
		...
		c-3.827,5.537-6.726,10.938-8.8,16.387c0,0-1.877,4.187,2.599,6.24C16.75,139.75,18.917,135.142,18.917,135.142z"/>
                                <g>
                                    <ellipse stroke="#adadad" cx="13.581" cy="132.93" rx="8.505" ry="8.623"/>
                                    <g>
                                        <path fill="#adadad" d="M9.299,135.199c1.237,2.396,4.154,3.322,6.52,2.07c2.364-1.252,3.278-4.211,2.042-6.605
		...
		C150.932,131.177,148.98,126.471,143.916,128.542z"/>
                                    <path fill="#adadad" d="M134.216,175.741c-1.006,3.659-0.392,7.386,1.394,10.407c0.041-0.399,0.109-0.801,0.221-1.197
		...
		c5.98,4.479,9.323,7.562,13.553,13.761c3.26,4.773,5.697,9.352,7.429,13.925C141.083,135.142,143.25,139.75,148.333,137.417z"/>
                                <g>
                                    <ellipse stroke="#adadad" cx="146.419" cy="132.93" rx="8.505" ry="8.623"/>
                                    <g>
                                        <path fill="#adadad" d="M148.659,128.592c-2.368-1.252-5.284-0.326-6.521,2.072c-1.236,2.395-0.322,5.354,2.043,6.605
				s5.282,0.326,6.52-2.07C151.936,132.803,151.021,129.844,148.659,128.592z"/>
                            ...
                            <path fill="#adadad" d="M125.283,131.334c0.048-13.081-1.633-26.163-5.186-39.244H80H39.903
		c-3.552,13.081-5.232,26.162-5.184,39.242L125.283,131.334z"/>
			...
			c0,3.526,2.859,6.386,6.386,6.386c3.526,0,6.385-2.859,6.385-6.386L61.27,200.63L61.27,200.63L61.27,200.63z"/>
                                ...
                                <g>
                                    <ellipse stroke="#adadad" cx="54.885" cy="200.79" rx="9.294" ry="9.423"/>
                                    <g>
                                        <path fill="#adadad" d="M60.607,203.823c-1.653,3.202-5.553,4.44-8.715,2.768c-3.163-1.677-4.383-5.628-2.73-8.832
			...
			c0,3.526-2.859,6.386-6.387,6.386c-3.525,0-6.385-2.859-6.385-6.386V200.63L98.73,200.63L98.73,200.63z"/>
                                ...
                                <g>
                                    <ellipse stroke="#adadad" cx="105.115" cy="200.79" rx="9.294" ry="9.423"/>
                                    <g>
                                        <path fill="#adadad" d="M102.123,194.988c3.159-1.672,7.064-0.434,8.715,2.771c1.653,3.204,0.434,7.155-2.73,8.832
                    ...
                    <h2>Приносим извинения, но текущая страница не найдена</h2>
                    <p>Если у вас возникли какие-то вопросы, обратитесь в тех. поддержку.
                        <a href="/admin/">Вернуться на Главную.</a></p>
                </div>
            </div>
        </div>
    </div>
