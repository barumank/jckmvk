...
export const setIsLoadingAction = createAction('PageAssociateAnalog/SearchInputProductAnalog/setIsLoadingAction');
const setResultsAction = createAction('PageAssociateAnalog/SearchInputProductAnalog/setResultsAction');
const setValueAction = createAction('PageAssociateAnalog/SearchInputProductAnalog/setValueAction');
